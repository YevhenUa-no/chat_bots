...
if not st.session_state.setup_complete:
    ...
    if input_method == "Type":
        ...
        st.session_state["experience"] = st.text_area(label="Experience", value=st.session_state["experience"], placeholder="Describe your experience", max_chars=500, key="experience_text_input")
